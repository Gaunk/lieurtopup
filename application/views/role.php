                                    ...
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $key['role'] ?></td>
                                                <td>
                                                    <a href="<?= base_url("admin/hapusMenu/" . $key['id']) ?>" data-toggle="modal" data-target="#hapusDataModal">
                                                        <i class="far fa-trash-alt"></i> Hapus
                                                    </a>
                                                            <a href="" class="text-success">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                     <a href="<?= base_url("admin/roleaccess/" . $key['id']) ?>" class="text-info">
                                                        <i class="fas fa-diagnoses"></i> Akses
                                                    </a>
                                                </td>
                                            </tr>
                                                  ...
                                                  <div class="modal-body">
                                                    ...
                                                    <form action="<?= base_url('admin/menu') ?>" method="post" id="createForm" onsubmit="event.preventDefault(); handleFormSubmit(this, 'Data berhasil di tambahkan!')">
                                                      <div class="form-group">
                                                        <label for="menu">Role Title</label>
